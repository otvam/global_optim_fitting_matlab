...
var_fix = {};
var_fix{end+1} = struct('name', 'log_opt', 'x0', 15.0);
var_fix{end+1} = struct('name', 'lin_opt', 'x0', [1.5 ; 2.5 ; 0.5]);

var_opt = {};
var_opt{end+1} = struct('name', 'log_var', 'x0', 1.0, 'lb', 0.01, 'ub', 100.0, 'tol_bnd', 0.05, 'trf', 'log', 'norm', true);
var_opt{end+1} = struct('name', 'lin_var', 'x0', [2.0 ; 2.0 ; 2.0], 'lb', 0.0, 'ub', 3.0, 'tol_bnd', 0.05, 'trf', 'lin', 'norm', true);
